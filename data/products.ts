...
/**
 * Catálogo mock: mezcla de piezas en stock y bajo pedido
 * para probar calculateProductDeliveryTime / carrito.
 */
export const products: Product[] = [
  {
    ...
    colors: ["crudo", "beige"],
    image:
      "https://images.unsplash.com/photo-1622227056993-6e7f88420855?w=400&h=400&fit=crop",
    stock: 3,
    production_time: 5,
    drying_time: 0,
    description:
      "Hermoso colgante de pared tejido a mano con algodón natural. Perfecto para dar calidez a cualquier espacio.",
  },
  {
    id: "2",
    ...
    category: "cemento",
    color: "gris",
    colors: ["gris", "beige", "terracota"],
    image:
      "https://images.unsplash.com/photo-1602028279679-aba5b4e2c75d?w=400&h=400&fit=crop",
    stock: 5,
    production_time: 3,
    drying_time: 2,
  ...
  },
  {
    ...
    drying_time: 2,
    description:
      "Macetero de cemento con diseño minimalista. Acabado natural que combina con cualquier decoración.",
  },
  {
    id: "4",
    ...
    colors: ["crudo", "beige"],
    image:
      "https://images.unsplash.com/photo-1602874801007-bd458bb1b8b6?w=400&h=400&fit=crop",
    stock: 10,
    production_time: 2,
    drying_time: 1,
    description:
      "Set de velas aromáticas de soja con aroma a vainilla. Hechas a mano con cera 100% natural.",
  },
  {
    id: "5",
  ...
  },
  {
    ...
    colors: ["crudo", "beige"],
    image:
      "https://images.unsplash.com/photo-1608181831688-ba943493b24e?w=400&h=400&fit=crop",
    stock: 12,
    production_time: 2,
    drying_time: 1,
  ...
  },
  {
    ...
    drying_time: 2,
    description:
      "Florero de cemento con diseño moderno y minimalista. Perfecto para flores secas o frescas.",
  },
  {
    id: "12",
    ...
    colors: ["crudo", "beige"],
    image:
      "https://images.unsplash.com/photo-1582643381669-1f7a9e90e5e0?w=400&h=400&fit=crop",
    stock: 1,
    production_time: 5,
    drying_time: 0,
  ...
  },
  {
    ...
    drying_time: 3,
    description:
      "Florero de cemento con textura única y acabado terracota. Pieza artesanal exclusiva.",
  },
]
