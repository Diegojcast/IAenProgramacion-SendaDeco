  ...
  return (
    <section className="py-20 md:py-28 px-5 md:px-8">
      <div className="container">
        <div className="rounded-3xl border border-border/50 bg-card/80 p-10 md:p-16 shadow-sm shadow-foreground/[0.03]">
          ...
          <div className="flex flex-col sm:flex-row gap-4 max-w-xl">
            <Input
              ...
              className="flex-1 h-12 rounded-full border-border/70 bg-background px-5"
            />
            <Button 
